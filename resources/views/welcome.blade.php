                        ...
                        <div class="movie__cta my-4">
                                    ...
                                    @auth
                                        <a href="#" class="btn btn-outline-light text-capitalize movie__fav-btn">
                                            <span class="far fa-heart movie__fav-icon movie-{{ $latest_movie->id }} {{ $latest_movie->is_favored ? 'fw-700' : '' }}"
            ...
            <img src="{{$movie->poster_path}}" class="img-fluid" alt="">
                ...
                <div class="movie__details text-white">
                    ...
                    <div class="d-flex movie__cta">
                        ...
                        @auth
                            <i class="far fa-heart {{ $movie->is_favored ? 'fw-700' : ''}} fa-1x align-self-center movie__fav-icon movie-{{ $movie->id }}"
